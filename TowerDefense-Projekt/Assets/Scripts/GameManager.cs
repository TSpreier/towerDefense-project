...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject gameObjectBuildingPanel;
    public Toggle toggleBuildingPanel;
    public AnimationClip animToggleBuildingPanelOff;
    public AnimationClip animToggleBuildingPanelOn;
    ...
    {
        if (toggleBuildingPanel.isOn)
        {
            anim.clip = animToggleBuildingPanelOn;
        }
        else
        {
            anim.clip = animToggleBuildingPanelOff;
        }
        anim.Play();
    }
}
